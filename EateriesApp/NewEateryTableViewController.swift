...
//  EateriesApp
//
//  Created by Dev Apps4Selling on 15/01/2019.
...
class NewEateryTableViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func saveButtonPressd(_ sender: UIBarButtonItem) {
        if nameTextField.text == "" || locationTextField.text == "" || typeTextField.text == "" {
            print("Не все поля заполнены")
            
            let alertCtrl = UIAlertController(title: nil, message: "Не все поля заполнены", preferredStyle: .alert)
